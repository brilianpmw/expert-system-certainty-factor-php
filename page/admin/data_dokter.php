...
$jumlahdata = count(query("SELECT*FROM user WHERE role='Dokter'"));
$jumlahhalaman = ceil($jumlahdata/$jumlahdataperhalaman);
$halamanaktif = (isset($_GET["halaman"])) ? $_GET["halaman"]:1;
$awaldata = ($jumlahdataperhalaman * $halamanaktif) - $jumlahdataperhalaman;

$duser = query("SELECT*FROM user WHERE role='Dokter' ORDER BY id_user asc LIMIT $awaldata, $jumlahdataperhalaman");

//tombol cari diklik
if ( isset($_POST["cari_userd"]) ) {
    $duser=cari_userd($_POST["keyword"]);
  }
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body text-center">
                    ...
                    <a class=" btn btn-outline-info mdi mdi-file btn-icon-prepend" href="tambah_dokter.php">Tambah Dokter</a>
                      <form class="form-inline" action="" method="post">
                        <input class="form-control mr-sm-2" type="text" placeholder="Nama Dokter.." name="keyword"  autocomplete="off" autofocus>
                        <button class="btn btn-outline-info my-2 my-sm-0" type="submit" name="cari_userd">Cari</button>
                      </form>
                    </nav><br>                    
