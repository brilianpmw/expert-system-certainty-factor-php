                      ...
                      <div class="row">
                        <div class="col-sm-6">
                          <div class="form-group">
                            ...
                            <input type="text" name="kode_gejala" id="kode_gejala" class="form-control" autocomplete="off" placeholder="Mis : G001"> 
                        </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="nama_gejala">Nama gejala :</label>
                                <input type="text" name="nama_gejala" id="nama_gejala" class="form-control" autocomplete="off" placeholder="Masukkan Nama gejala"> 
                              </div>
                        </div>
                      </div>
