              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body text-center">
                    <h4 class="card-title">Ubah Bahan Makanan</h4>
                    <hr><br><br>

                    <form action="" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="id_bahan" value="<?= $kt["id_bahan"]; ?>">
                    
                      <div class="row">
                        <div class="col-sm-6">
                          <div class="form-group">
                            <label for="kode_bahan">Kode Bahan :</label>
                            <input type="text" name="kode_bahan" id="kode_bahan" class="form-control" readonly value="<?= $kt["kode_bahan"];?>" >
                          </div>
                        </div>
                        <div class="col-sm-6">
                          <div class="form-group">
                            <label for="nama_bahan">Nama bahan :</label>
                            <input type="text" name="nama_bahan" id="nama_bahan" class="form-control" value="<?= $kt["nama_bahan"];?>" autocomplete="off" required>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-sm-6">
                          <div class="form-group">
                            ...
                            <input type="text" name="kalori" id="kalori" class="form-control"  value="<?= $kt["kalori"];?>" autocomplete="off" required>
                          </div>
                        </div>
                        <div class="col-sm-6">
                          <div class="form-group">
                            <label for="lemak">Lemak :</label>
                            <input type="text" name="lemak" id="lemak" class="form-control" value="<?= $kt["lemak"];?>" autocomplete="off" required>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-sm-6">
                          <div class="form-group">
                            ...
                            <input type="text" name="karbohidrat" id="karbohidrat" class="form-control"  value="<?= $kt["karbohidrat"];?>" autocomplete="off" required>
                          </div>
                        </div>
                        <div class="col-sm-6">
                          <div class="form-group">
                            <label for="protein">Protein :</label>
                            <input type="text" name="protein" id="protein" class="form-control" value="<?= $kt["protein"];?>" autocomplete="off" required >
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="ket" id="ket" rows="6" autocomplete="off" required>
                                  <?= $kt["ket"];?> 
                                </textarea>
                            </div>
                        </div>
                      ...
                      <button type="submit" name="submit" class="btn btn-info">Ubah Data Gejala</button>
                    </form>
                  </div>
                </div>
              </div>
