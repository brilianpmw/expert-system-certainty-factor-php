...
$jumlahdata = count(query("SELECT*FROM hasilkonsultasi"));
...
$dhk = query("SELECT user.nama, penyakit.nama_penyakit,hasilkonsultasi.tanggal,hasilkonsultasi.id_konsultasi
              FROM user, penyakit, hasilkonsultasi
                WHERE user.id_user=hasilkonsultasi.id_user
                  ...
                  ORDER BY tanggal asc LIMIT $awaldata, $jumlahdataperhalaman
            ");


//tombol cari diklik
if ( isset($_POST["cari_riwayat"]) ) {
  $dhk=cari_riwayat($_POST["keyword"]);
}
?>
                  ...
                  <div class="card-body text-center">
                    ...
                    <a class="" href=""></a>
                      ...
                      <form class="form-inline" action="" method="post">
                        ...
                        <button class="btn btn-outline-info my-2 my-sm-0" type="submit" name="cari_riwayat">Cari</button>
                      </form>
                    </nav><br>
