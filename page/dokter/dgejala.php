...
$dgejala = query("SELECT*FROM gejala ORDER BY id_gejala asc LIMIT $awaldata, $jumlahdataperhalaman");

//tombol cari diklik
if ( isset($_POST["cari_gejala"]) ) {
  $dgejala=cari_gejala($_POST["keyword"]);
}
?>
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body text-center">
                    ...
                    <a class=" btn btn-outline-info mdi mdi-file btn-icon-prepend" href="tambah_gejala.php">Tambah</a>
                      ...
                      <form class="form-inline" action="" method="post">
                        ...
                        <table class="table table-bordered">
                            ...
                            <td>
                              <a href="ubah_gejala.php?id=<?= $row["id_gejala"];?>" class="mdi mdi-autorenew"> Ubah</a> |
                              <a href="hapus_gejala.php?id=<?= $row["id_gejala"];?>" onclick=" return confirm('Yakin ingin menghapus data ?');">Hapus<a class="mdi mdi-delete"></a></a>
                            </td>
                            </tr>
                            <?php $i++; ?>
                            <?php endforeach; ?>
