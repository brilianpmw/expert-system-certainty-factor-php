...
$kt = query("SELECT * FROM gejala WHERE id_gejala=$id_gejala")[0];
  ...
  if (ubah_gejala ($_POST) > 0 ) {
    echo "
      <script>
        ...
        document.location.href = 'dgejala.php';
      </script>  
    ";
  } else {
    echo "
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body text-center">
                    ...
                    <input type="hidden" name="id_gejala" value="<?= $kt["id_gejala"]; ?>">
                    
                      <div class="row">
                        <div class="col-sm-6">       
                            <div class="form-group">
                              <label for="kode_gejala">Kode gejala :</label>
                              <input type="text" name="kode_gejala" id="kode_gejala" class="form-control" readonly value="<?= $kt["kode_gejala"];?>" > 
                            </div>                         
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="nama_gejala">Nama gejala :</label>
                                <input type="text" name="nama_gejala" id="nama_gejala" autocomplete="off" class="form-control" value="<?= $kt["nama_gejala"];?>" > 
                            </div>
                        </div>
                      </div>
