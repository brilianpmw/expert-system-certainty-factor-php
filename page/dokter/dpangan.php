...
$dbahan = query("SELECT*FROM bpangan ORDER BY id_bahan asc LIMIT $awaldata, $jumlahdataperhalaman");
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body text-center">
                    <h4 class="card-title">Data Bahan Pangan</h4>
                    <hr>
                    
                    <nav class="navbar navbar-light ">
                    <a class=" btn btn-outline-info mdi mdi-file btn-icon-prepend" href="tambah_bahan.php">Tambah</a>

                      <form class="form-inline" action="" method="post">
                        <input class="form-control mr-sm-2" type="text" placeholder="Cari Nama bahan.." name="keyword"  autocomplete="off" autofocus>
                        <button class="btn btn-outline-info my-2 my-sm-0" type="submit" name="cari_bahan">Cari</button>
                      </form>
                    </nav><br>
                        ...
                        <table class="table table-bordered">
                            ...
                            <td>
                              <a href="ubah_bahan.php?id=<?= $row["id_bahan"];?>" class="mdi mdi-autorenew"> Ubah</a> |
                              <a href="hapus_bahan.php?id=<?= $row["id_bahan"];?>" onclick=" return confirm('Yakin ingin menghapus data ?');">Hapus<a class="mdi mdi-delete"></a></a>
                            </td>
                            </tr>
                            <?php $i++; ?>
                            <?php endforeach; ?>
