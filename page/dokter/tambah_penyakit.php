                  ...
                  <div class="card-body text-center">
                    ...
                    <div class="container">
                      <div class="row text-center">
                        <div class="col-sm-12">
                          <div class="form-group">
                            ...
                            <input type="text" name="kode_penyakit" id="kode_penyakit" class="form-control" autocomplete="off" placeholder="Mis : P001" > 
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-sm-6">
                          <div class="form-group">
                            ...
                            <input type="text" name="nama_penyakit" id="nama_penyakit" class="form-control" autocomplete="off" placeholder="Maukkan Nama Penyakit" > 
                          </div>
                        </div>
                        <div class="col-sm-6">
                          <div class="form-group">
                      ...
                      <div class="row">
                        <div class="col-sm-6">
                          <div class="form-group">
                            <label for="penyebab"><h5>Penyebab : </h5></label>
                            <textarea class="form-control" name="penyebab" id="penyebab" rows="4" autocomplete="off" placeholder="Masukkan Keterangan : "></textarea>
                          </div>
                        </div>
                        <div class="col-sm-6">
                          <div class="form-group">
                            <label for="solusi"><h5> Solusi : </h5></label>
                            <textarea class="form-control" name="solusi" id="solusi" rows="4" autocomplete="off" placeholder="Masukkan Solusi : "></textarea>
                          </div>
                        </div>
                      </div>
                      <div class="row text-center">
                        <div class="col-sm-12">
                          <div class="form-group">
                            ...
                            <textarea class="form-control" name="keterangan" id="keterangan" rows="4" autocomplete="off" placeholder="Masukkan Keterangan : "></textarea>
                          </div>
                        </div>
                      </div>
                    </div>
                      <button type="submit" name="submit" class="btn btn-info">Tambah Data Penyakit</button>
                    </form>
                  </div>
                </div>
              </div>
