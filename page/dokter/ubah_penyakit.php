              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body text-center">
                    <h4 class="card-title">Ubah Penyakit</h4>
                    <hr><br><br>

                    <form action="" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="id_penyakit" value="<?= $kt["id_penyakit"]; ?>">
                    <input type="hidden" name="gambarLama" value="<?= $kt["gambar"]; ?>">

                    <div class="container">
                      <div class="row text-center">
                        <div class="col-sm-12">
                          <div class="form-group">
                            <label for="kode_penyakit"><h5>Kode Penyakit :</h5></label>
                            <input type="text" name="kode_penyakit" id="kode_penyakit" class="form-control" readonly value="<?= $kt["kode_penyakit"];?>" > 
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-sm-6">
                          <div class="form-group">
                            <label for="nama_penyakit"><h5>Nama Penyakit :</h5></label>
                            <input type="text" name="nama_penyakit" id="nama_penyakit" class="form-control" value="<?= $kt["nama_penyakit"];?>" > 
                          </div>
                        </div>
                        <div class="col-sm-6">
                          <div class="form-group">
                            <label for="gambar"><h5>Gambar :</h5></label>
                            <img src="../../img/<?= $kt['gambar']; ?>" width="150" alt=""><br><br>
                      ...
                      <div class="row">
                        <div class="col-sm-6">
                          <div class="form-group">
                            <label for="keterangan"><h5>Penyebab : </h5></label>
                            <textarea class="form-control" name="penyebab" id="penyebab" rows="4">  <?= $kt["penyebab"];?> </textarea>
                          </div>
                        </div>
                        <div class="col-sm-6">
                          <div class="form-group">
                            <label for="solusi"><h5>Solusi : </h5></label>
                            <textarea class="form-control" name="solusi" id="solusi" rows="4">  <?= $kt["solusi"];?> </textarea>
                          </div>
                        </div>
                      </div>
                      <div class="row text-center">
                        <div class="col-sm-12">
                          <div class="form-group">
                            <label for="kode_penyakit"><h5>Keterangan :</h5></label>
                            <textarea class="form-control" name="keterangan" id="keterangan" rows="4">  <?= $kt["keterangan"];?> </textarea>
                          </div>
                        </div>
                      </div>
                    </div>
                      <button type="submit" name="submit" class="btn btn-info">Ubah Data Penyakit</button>
                    </form>
                  </div>
                </div>
              </div>
