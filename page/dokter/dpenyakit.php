...
$dpenyakit = query("SELECT*FROM penyakit ORDER BY id_penyakit asc LIMIT $awaldata, $jumlahdataperhalaman");

//tombol cari diklik
if ( isset($_POST["cari_penyakit"]) ) {
  $dpenyakit=cari_penyakit($_POST["keyword"]);
}
?>
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body text-center">
                    ...
                    <a class=" btn btn-outline-info mdi mdi-file btn-icon-prepend" href="tambah_penyakit.php">Tambah</a>
                      ...
                      <form class="form-inline" action="" method="post">
                        ...
                        <button class="btn btn-outline-info my-2 my-sm-0" type="submit" name="cari_penyakit">Cari</button>
                      </form>
                    </nav><br>
                        ...
                        <table class="table table-bordered">
                            ...
                            <td>
                              <a href="ubah_penyakit.php?id=<?= $row["id_penyakit"];?>" class="mdi mdi-autorenew"> Ubah</a> |
                              <a href="hapus_penyakit.php?id=<?= $row["id_penyakit"];?>" onclick=" return confirm('Yakin ingin menghapus data ?');">Hapus<a class="mdi mdi-delete"></a></a>
                            </td>
                            </tr>
                            <?php $i++; ?>
                            <?php endforeach; ?>
